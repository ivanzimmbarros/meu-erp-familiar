...
# ─────────────────────────────────────────────
#  CSS GLOBAL — FORÇAR MODO CLARO E CORES SUAVES
# ─────────────────────────────────────────────
st.markdown("""
<style>
    /* 1. FUNDO DA PÁGINA */
    ...
    /* 2. INPUTS (Adeus fundo preto, olá branco) */
    ...
    /* 3. BOTÕES (Azul Marinho com texto Branco sempre visível) */
    .stButton > button {
    ...
    /* Garante que o texto do botão não suma ao passar o mouse */
